  ...
  return (
    <main className="min-h-screen bg-bc-1 text-bc-2 flex items-center justify-center">
      <div className="text-center px-5">
        ...
        <p className="text-xl mb-8">It's either you're lost or we made a mistake. Syempre ikaw may kasalanan, bakit kami mag so-sorry? Hinahanap-hanap mo parin yung wala naman talaga.</p>
        <Link
          href="/"
