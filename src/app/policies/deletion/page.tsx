...
export const metadata = {
  ...
  description: "You can delete your data at any time using the application's built-in deletion feature.",
  ...
  filePath: path.join(process.cwd(), "public", "md", "deletion.md"),
};

export default async function DataDeletionPolicy() {
